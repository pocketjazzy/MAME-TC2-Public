...
includedirs {
	...
	MAME_DIR .. "src/mame", -- P068 (CrouchCrisis): ui/linkplay.cpp reaches the namco_c139 link device
	MAME_DIR .. "src/lib",
...
files {
	...
	MAME_DIR .. "src/frontend/mame/ui/linkplay.cpp", -- P068 (CrouchCrisis): Link Play Config menu
	MAME_DIR .. "src/frontend/mame/ui/linkplay.h",
